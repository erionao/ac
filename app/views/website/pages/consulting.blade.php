...
<section class="cover_consulting_page" style="background-image: url({{ URL::to('/uploads/background/' . $sections[0]['images'][0]['image']); }}) !important">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
...
<section class="inerpages_section_home" id="consulting_first_s">
    <div class="container-fluid">
        <div class="row first_consulting_inn" style="background-image: url({{ URL::to('/uploads/background/' . $sections[1]['images'][0]['image']); }}) !important">
        ...
        <div class="row second_consulting_inn" style="background-image: url({{ URL::to('/uploads/background/' . $sections[2]['images'][0]['image']); }}) !important">
            <div class="col-md-6 no_padding mobile-d-n">
            </div>
            <div class="col-md-6 "><br>&nbsp;
                <h1 class="wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".5s">Food & Beverage Consulting Services</h1>
                <div class="wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".3s">{{$sections[2]['content']}}</div>
