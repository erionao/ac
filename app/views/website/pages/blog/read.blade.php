...
<head>
    ...
    <!-- =========================
          FAV AND TOUCH ICONS
    ============================== -->
    <link rel="shortcut icon" href=href="{{URL::to('webassets/images/ac.ico')}}>
...
<div class="blog blog-2">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="blog-container col-md-offset-2 col-md-8 col-sm-8 col-xs-12">
                <h2 class="section-title news-titulli"><span class="bold700">{{$blog->title}}</span></h2>

                <div class="blog-item-image news-content-image">
                    <img src="{{URL::to('uploads/blogs/images/'. $blog->images[0]->image)}}" alt="">
                    <div class="blog-item-info">
                        <div class="blog-item-date news-img-date"><i class="fa fa-calendar-o"></i> 08.03.2017</div>

                        <div class="blog-item-category"><i class="fa fa-folder-o"></i>{{$blog->title}}</div>
                    </div>
                </div>
            </div>
        </div>
...
<div class="doctors doctors-2">
    <div class="container">
        <div class="row">
            <div class="blog-container  col-md-offset-2 col-md-8 col-sm-8 col-xs-12">
                <h3 class="section-title news-nentitulli"><span class="bold700">{{$blog->subtitle}}</span></h3>

                <h3 class="qs-text">
                    {{$blog->content}}

                </h3> </div>
            @if($blog->youtube_link != null)
            <div class="video-news row">
